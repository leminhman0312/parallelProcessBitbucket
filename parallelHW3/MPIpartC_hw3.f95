program partC
    ...
    integer :: i,j,iTrue,k
    real,dimension(:,:),ALLOCATABLE:: s_local, s_global, b_local, b_global, g_local, g_global
    real :: q = 0.15
    real,DIMENSION(:), ALLOCATABLE :: x_local, y_local, y_global, x_global
    integer :: ncol = 10
    ...
    do timecount = 1,1000
        ...
        do i = 1,nblocks
            ...
            y_local(i) = y_local(i) + (q/REAL(ncol)) 
    ...
    call MPI_Reduce(ymaxlocal,ymax,1,MPI_REAL,MPI_MAX, 0, MPI_COMM_WORLD,ierr)


    
    yminlocal = minval(y_local) 
    call MPI_Reduce(yminlocal,ymin,1,MPI_REAL,MPI_MIN, 0, MPI_COMM_WORLD,ierr)
